...
public class CardAdapter_8 extends RecyclerView.Adapter<CardAdapter_8.ViewHolder>{
   ...
   public CardAdapter_8() {
       ...
       cardSetterGetter = new CardSetterGetter();
       cardSetterGetter.setName("Group Discussion");
       cardSetterGetter.setThumbnail(R.drawable.group);
       mItems.add(cardSetterGetter);

       cardSetterGetter = new CardSetterGetter();
       cardSetterGetter.setName("Business Plan");
       cardSetterGetter.setThumbnail(R.drawable.plan);
       mItems.add(cardSetterGetter);
   ...
   public int getItemCount() {
    ...
    static class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener{
        int position;
        String s[]={"Paper Presentation_8","Poster Presentation_8","Group Discussion_8","Business Plan_8"};
